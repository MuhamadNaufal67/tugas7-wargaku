...
export default function StatusPage() {
  ...
  const [recentPdfMessage, setRecentPdfMessage] = useState<string>("");
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <section className="space-y-4">
        ...
        {isLoading ? (
          <div className="grid gap-4 xl:grid-cols-2">
            {Array.from({ length: 4 }).map((_, index) => (
              <div
                key={index}
                className="rounded-[1.7rem] border border-white/80 bg-white/95 p-5 shadow-sm"
              >
                <div className="animate-pulse space-y-4">
                  ...
                  <div className="h-12 rounded-[1.1rem] bg-slate-100" />
        ...
        {!isLoading && errorMessage ? (
          <div className="rounded-[1.2rem] border border-red-200 bg-red-50 px-5 py-4 text-sm text-red-600">
            {errorMessage}
          </div>
        ) : null}

        {!isLoading && !errorMessage && filteredPengajuan.length === 0 ? (
          <div className="rounded-[1.5rem] border border-slate-200 bg-white px-5 py-10 text-center shadow-sm">
            ...
            <div className="max-h-[75vh] overflow-y-auto p-5 sm:p-6">
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div key={field.label} className="rounded-xl bg-slate-50 p-3.5">
              ...
              {isAdmin ? (
                <div className="mt-4 space-y-3">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        Template resmi akan dipakai otomatis saat admin mengubah status menjadi selesai.
                      </p>
                    </div>
                    {recentPdfMessage ? (
                  ...
                  <LetterTemplatePreview
                    ...
                    nomorSurat={prepareSubmissionPdf(activeSelectedPengajuan).nomorSurat}
                  />
